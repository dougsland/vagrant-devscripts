...
set +x
export CI_TOKEN='sha256---CHANGE-HERE'
set -x
...
#export OPENSHIFT_RELEASE_STREAM=4.10
...
#export OPENSHIFT_VERSION=latest-4.10
...
export CUSTOM_REPO_FILE=ocp_douglas.repo
...
# Manage bridge
#export MANAGE_BR_BRIDGE=ostestbm
